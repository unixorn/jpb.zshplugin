...
if [[ "$(uname -s)" = "Darwin" ]]; then
  ...
  if [ -f /usr/local/Cellar/mysql/5.6.26/homebrew.mxcl.mysql.plist ]; then
    alias mysql-load="launchctl load -w /usr/local/Cellar/mysql/5.6.26/homebrew.mxcl.mysql.plist"
    alias mysql-unload="launchctl unload -w /usr/local/Cellar/mysql/5.6.26/homebrew.mxcl.mysql.plist"
  fi

  if [ -f /usr/local/Cellar/postgresql/9.1.3/homebrew.mxcl.postgresql.plist ]; then
    alias postgres-load="launchctl load -w /usr/local/Cellar/postgresql/9.4.4/homebrew.mxcl.postgresql.plist"
    alias postgres-unload="launchctl unload -w /usr/local/Cellar/postgresql/9.4.4/homebrew.mxcl.postgresql.plist"
  fi
